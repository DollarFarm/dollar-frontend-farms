...
const BuyAction: React.FC<BuyActionProps> = ({ busdBalance, tokensUnclaimed, tokenBalance, tokensLeft }) => {
    ...
    const [onPresentBuy] = useModal(
        <BuyModal max={busdBalance} onConfirm={onBuy}  tokenName="DOLLARS" tokensUnclaimed={tokensUnclaimed} tokenBalance={tokenBalance} tokensLeft={tokensLeft} />
    )

    const renderStakingButtons = () => {
        return <Button fullWidth  onClick={onPresentBuy}>Lock</Button>
    }
